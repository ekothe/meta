...
{
dat_ES <- escalc(measure="COR", ri=ri, ni=ni, data=dat)
## Note, to use r-to-z transformed correlations use measure = "ZCOR"
...
## ----run_MA--------------------------------------------------------------
dat_MA<- rma(yi, vi, data=dat_ES, slab=paste(authors, year))
